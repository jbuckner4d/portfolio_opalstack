...
<p class="has-text-align-center"><?php echo esc_html__( 'No posts found', 'resumegrove' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"resumegrove","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group -->