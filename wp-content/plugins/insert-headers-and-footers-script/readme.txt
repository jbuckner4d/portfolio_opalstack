...
= Version: 1.1.2 - Date: 16 May 2024 =
* Tweak: Opt-in message to provide non-sensitive diagnostic data.
* Fixed: Escaping issues have been resolved in multiple areas.

= Version: 1.1.1 - Date: 05 June 2023 =
* Enhanced some option name labels
* Updated language file

= Version: 1.1.0 - Date: 25 Feb 2023 =
* Fixed: PHP version compatibility issue for file naming

= Version: 1.0.9 - Date: 22 Feb 2023 =
* Update: CMB2 to latest version.
* Fixed: Inactive status option not working.

= Version: 1.0.8 - Date: 26 Sep 2021 =
